  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        {/* Main Chart */}
        <div className="lg:col-span-2 bg-card/50 border border-border rounded-2xl p-6 shadow-xl relative overflow-hidden">
          <div className="absolute top-0 right-0 p-6">
            <div className="flex items-center gap-4 text-[10px] font-bold uppercase tracking-widest">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-foreground/80">AI Predicted</span>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-primary/5 border border-primary/20 rounded-2xl p-6 flex flex-col items-center text-center">
            ...
            <button className="w-full py-2 bg-primary hover:bg-primary/90 text-primary-foreground text-[11px] font-bold uppercase tracking-widest rounded-xl transition-all shadow-lg shadow-primary/20">
