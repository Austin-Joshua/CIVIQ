    ...
    <div className="min-h-screen bg-gradient-to-b from-page-from to-page-to flex items-center justify-center p-4 lg:p-10 font-outfit overflow-hidden text-foreground transition-colors duration-300">
      ...
      <div className="relative z-10 w-full max-w-7xl bg-panel-bg border border-slate-200 dark:border-white/5 rounded-[2.5rem] overflow-hidden shadow-3xl auth-flip-enter">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
          {/* Form Side */}
          <div className="p-8 lg:p-20 flex flex-col justify-center bg-panel-bg text-foreground auth-panel-slide-right">
            {/* Mobile Logo removed for cleanup as it's redundant with the brand panel */}
          ...
          {/* Visual Side */}
          <div className="hidden lg:block relative bg-visual-to overflow-hidden auth-panel-slide-left">
            <div className="absolute inset-0 bg-gradient-to-br from-visual-from to-visual-to z-10" />
            <button 
              onClick={() => router.push('/')}
              className="absolute top-12 right-12 z-20 flex items-center gap-2 text-white/70 hover:text-white transition-colors group w-fit p-1"
            >
